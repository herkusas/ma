...
(
    ...
    "client_id"                                 integer                                             NOT NULL,
    CONSTRAINT "primary_key_client_grants" PRIMARY KEY ("id"),
    CONSTRAINT "foreign_key_client_grants_clients_client_id" FOREIGN KEY ("client_id")
        REFERENCES clients ("id") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS "UI_client_grant_id"
    ON client_grants USING btree
    ("client_id" ASC NULLS LAST);
...
VALUES ('test_client', 'test client', 3600);
...
VALUES (1, '42BD490AC869ED79253392E00E31E0CCCEEF0724', 'X509Thumbprint');
